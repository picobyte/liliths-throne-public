...
public class SMBreedingStallFront extends SexManagerDefault {
	...
	public SMBreedingStallFront(ArrayList<SexAreaOrifice> allowedOrifices, Map<GameCharacter, SexPositionSlot> dominants, Map<GameCharacter, SexPositionSlot> submissives) {
